				...
				<div class="col-xl-10">
					<div class="service-boxes wow fadeInRight" data-wow-delay="400ms">
						<div class="service-box services_services">
							...
							<h4 class="title">
								<a>Сбор, подготовка,<br>апостиль документов</a>
							</h4>
						...
						<div class="service-box services_services">
							...
							<h4 class="title">
								<a>Персональное сопровождение <br>при подаче на гражданство</a>
							</h4>
						...
						<div class="service-box services_services">
							...
							<h4 class="title">
								<a >Подготовка <br> к сдаче присяги</a>
							</h4>
						...
						<div class="service-box services_services">
							...
							<h4 class="title">
								<a >Получение второго <br> гражданства</a>
							</h4>
						...
						<div class="service-box services_services">
							...
							<h4 class="title">
								<a >Оформление внутренних <br> европейских документов</a>
							</h4>
