			...
			<div class="row justify-content-lg-between align-items-center justify-content-center">
				<div class="col-lg-5 col-md-8">
					<div class="about-tag-img wow fadeInLeft">
						<img src="assets/img/about/about-01.jpg" alt="Image">
				...
				<div class="col-lg-6 col-md-10">
					<div class="about-text p-left wow fadeInRight">
						...
						<ul class="mt-40">
							<li><span>---</span> core leve design</li>
							<li><span>---</span> solid material</li>
							<li><span>---</span> pure hand work</li>
							<li><span>---</span> 24/7 Online Support</li>
						</ul>
						<a href="about.html" class="main-btn main-btn-2 mt-30">learn more <span class="icon">+</span></a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-6 col-md-10 order-2 order-lg-1">
					<div class="feature-text">
						<div class="section-title mb-40 wow fadeInLeft" data-wow-delay="300ms">
							...
							<h2 class="title">
								get solid solutions <span>in the mean time</span>
							</h2>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
								incididunt.
